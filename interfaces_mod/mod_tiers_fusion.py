...
from _helpers.tiers_fusion_helpers import TiersFusionHelpers

class TiersFusionEditor(tk.Toplevel):
    def __init__(self, parent, selected_tiers, services=None):
        super().__init__(parent)

        # Construction de l'interface
        self.title("Fusionner les Tiers")
        ...
        self.helper = TiersFusionHelpers(services)
        self.helper.load_data(selected_tiers)
...
if __name__ == '__main__':
    ...
    selected_tiers = [
        {'iid_key': 54, 'id_tiers': 54, 'organisation': 'AMAZON', 'actif': True},
        {'iid_key': 126, 'id_tiers': 126, 'organisation': 'AMAZON', 'actif': True}
    ]
